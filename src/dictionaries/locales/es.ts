      ...
      projectItens: [
        {
          ...
          description:
            'IBGE Chart Data desata el poder de los datos del IBGE a través de gráficos y visualizaciones dinámicas. Explora tendencias económicas, cambios demográficos y más a través de niveles geográficos. IBGE Chart Data hace que los datos complejos sean accesibles y útiles para todos.',
        },
        {
          title: 'Find A Friend',
          projectLink:
        ...
        },
        {
          ...
          description:
            'Futura Equipamentos Website es un sitio web para una empresa que vende e instala máquinas de resorte. Construido con las últimas tecnologías, es un sitio web moderno, rápido, responsive y optimizado para SEO.',
        },
        {
          title: 'Gym Pass',
          projectLink:
