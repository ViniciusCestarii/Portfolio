...
export default function Home() {
  ...
  const imgCodeUrl = useMemo(
    () =>
      `https://readme-typing-svg.demolab.com?font=Source+Code+Pro&duration=400&pause=0&color=${theme.palette.primary.main.substring(
        1,
          ...
          >
            ...
            {profileData && (
              <Image
                ...
                height={576}
                priority
                alt="Vinicius Cestari profile picture"
              />
            )}
          </Box>
          <Box className=" row-span-2 sm:col-span-2 sm:row-span-1 flex items-center justify-center relative">
            <Box
              sx={{
                backgroundImage:
                  'url(https://source.unsplash.com/2000x1000/?code,programming,developer)',
              }}
