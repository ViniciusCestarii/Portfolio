    ...
    <main>
      ...
      >
        <Box className="grid grid-cols-3 h-full">
          ...
          <Box className="col-span-2 flex items-center justify-center relative">
            <Box
              sx={{
                backgroundImage:
                  'url(https://source.unsplash.com/2000x1000/?code)',
              }}
